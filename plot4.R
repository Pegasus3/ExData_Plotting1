...
## Plot 4
 ...
 ## Present 4 icons in this PNG plot
 par(mfrow = c(2, 2)) 

 plot(tidy$Time, tidy$Global_active_power, type="l", xlab="", ylab="Global Active Power", cex=0.2)

 plot(tidy$Time, tidy$Voltage, type="l", xlab="datetime", ylab="Voltage")
 ...
 plot(tidy$Time, tidy$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
